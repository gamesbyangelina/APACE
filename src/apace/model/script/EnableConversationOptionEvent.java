...
public class EnableConversationOptionEvent extends AbstractScriptEvent{

	private int node;
	private String option;

	public EnableConversationOptionEvent(int nodeId, String option){
		this.node = nodeId;
		this.option = option;
	}
	...
	public void onExecute(PACGame game){
		...
		ConversationManager.getConversation(node).enableOption(option);
	}
